...
```bash
# Linux amd64
curl -O -L https://github.com/lnsp/koala/releases/download/v0.5.2/koala-v0.5.2-darwin-amd64.tar.gz
# Linux arm
curl -O -L https://github.com/lnsp/koala/releases/download/v0.5.2/koala-v0.5.2-linux-arm.tar.gz
# macOS amd64
curl -O -L https://github.com/lnsp/koala/releases/download/v0.5.2/koala-v0.5.2-darwin-amd64.tar.gz
```
...
```bash
tar -C /opt -xzvf koala-v0.5.2-*.tar.gz
```
